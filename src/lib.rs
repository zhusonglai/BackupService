// src/lib.rs
/*
 * Core library for BackupService
 */
...
#[derive(Debug)]
pub struct BackupServiceProcessor {
    verbose: bool,
    processed_count: usize,
}

impl BackupServiceProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting BackupService processing");
    
    let mut processor = BackupServiceProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = BackupServiceProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = BackupServiceProcessor::new(false);
